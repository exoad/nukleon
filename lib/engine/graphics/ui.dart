...
class NineSliceScaledPainter extends ContentRenderer with RenderingMixin {
  ...
  NineSliceScaledPainter(
      ...
      : _sliceSize = sprite.src.width / 3,
        _corners = facetHints.renderCorners ? Float32List(16) : null,
        _horiSides = facetHints.renderHorizontalSides ? Float32List(8) : null,
        _vertSides = facetHints.renderVerticalSides ? Float32List(8) : null,
        _center = facetHints.renderCenter ? Float32List(4) : null,
    ...
    if (facetHints.renderHorizontalSides) {
      // top center
    ...
    if (facetHints.renderVerticalSides) {
      // center left

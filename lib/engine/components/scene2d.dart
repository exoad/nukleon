/// A very easy to use set of classes that deal with creating a directed scene graph
/// backed by a directed graph [DGraph].
///
/// It can be seen as an house builtin alternative to Flutter's [Navigator], but instead
/// this operates solely on the [Canvas] API.
library;

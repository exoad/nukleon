...
bool Win32Window::Create(const std::wstring& title, const Point& origin,
  ...
  HWND window = CreateWindow(
      ...
      static_cast<int>((GetSystemMetrics(SM_CXSCREEN) / 2) -
                       Scale(size.width / 2, scale_factor)),
      static_cast<int>((GetSystemMetrics(SM_CYSCREEN) / 2) -
                       Scale(size.height / 2, scale_factor)),
